...
<s:form id="gameInviteAnswersConfirmForm" beanclass="com.wordpong.app.action.game.GameInviteActionBean" method="post">
    <div>
	    <!-- Back Button -->
...
<div data-role="content" style="padding-top:0px;">
	...
	<s:form id="gameInviteAnswersConfirmForm" beanclass="com.wordpong.app.action.game.GameInviteActionBean" method="post">
		<ul data-role="listview" data-inset="true" data-theme="c" data-dividertheme="b" style="margin-top:0px;">
			...
			<li><s:label for="questions: ${actionBean.answer.questionDescription}"/></li> 
			<li><s:label for="with: ${actionBean.inviteGame.inviterDetails}"/>      </li> 
		</ul>
	    ...
	    <s:hidden name="answerKeyStringEncrypted" value="${answer.keyStringEncrypted}" />
