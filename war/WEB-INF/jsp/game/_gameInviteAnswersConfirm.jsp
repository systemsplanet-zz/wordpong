...
<s:useActionBean id="bean" beanclass="com.wordpong.app.action.game.GameInviteAnswersConfirmActionBean"/>
    ...
    <div>
	    ...
	    <div style="float:left;margin-left:10px">
	        <div data-theme="a" class="ui-btn ui-btn-up-a ui-btn-icon-left ui-btn-corner-all ui-shadow">
	            ...
	            <input name="cancel" value="${cancelLbl}" data-theme="a" class="process ui-btn-left  ui-btn-hidden" data-icon="arrow-l" type="submit">
	        </div> 
	    </div>
    </div>
</s:form>   
